...
-- Standard program :
    ...
    awful.key({ ctrl, shift }, "f", function () awful.spawn(string.format("pcmanfm")) end,
     ...
     -- Dmenu :
    awful.key({ modkey, shift }, "Return", function () awful.spawn(string.format("dmenu_run"))end, 
        {description = "dmenu_run", group = "hotkeys"}),
	...
	-- Rofi :
    awful.key({ modkey }, "p", function () awful.spawn(string.format("rofi -show run")) end,
